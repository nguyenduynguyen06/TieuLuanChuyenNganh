...
const FilterBar = () => {
    ...
    const menu2 = (
        <Menu>
            <Menu.Item key="5">64GB đến 128GB</Menu.Item>
            <Menu.Item key="6">256GB đến 512GB</Menu.Item>
            <Menu.Item key="7">Trên 512GB</Menu.Item>
        </Menu>
    );
    const menu3 = (
        <Menu>
            <Menu.Item key="8">5 sao</Menu.Item>
            <Menu.Item key="9">4 sao</Menu.Item>
            <Menu.Item key="10">3 sao</Menu.Item>
            <Menu.Item key="11">2 sao</Menu.Item>
            <Menu.Item key="12">1 sao</Menu.Item>
