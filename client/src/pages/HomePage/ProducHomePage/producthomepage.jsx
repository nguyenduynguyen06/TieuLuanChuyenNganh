...
function ProductHomePage() {
  ...
  return (
    ...
    <Card.Grid style={{ ...gridStyle ,cursor: 'pointer', minBlockSize: '100%'} }onClick={() => handleCardClick(123)}>
    <MDBCard>
  ...
  <Card.Grid style={{ ...gridStyle ,cursor: 'pointer', minWidth: '100%'} }onClick={() => handleCardClick(123)}>
    <MDBCard>
      <MDBRipple rippleColor='light' rippleTag='div' className='bg-image hover-overlay'>
        <MDBCardImage src='https://cdn.tgdd.vn/Products/Images/42/289700/iphone-14-pro-max-den-thumb-600x600.jpg' fluid alt='...'/>
